...
prediction_file_path = "C:/Users/khand/OneDrive/Desktop/final year project/CaDRReS-master/output/ccle_all_pred_end.csv"
...
def download_sensitive_csv(cell_line, selected_drug):
    ...
    return send_file(sensitive_csv, as_attachment=True, download_name='{}_{}_sensitive_cell_lines.csv'.format(cell_line, selected_drug))
